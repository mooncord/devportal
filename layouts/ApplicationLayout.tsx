      ...
      headingChildren={
        docLink && (
          <Link href={docLink.href}>
            <a className='hover:underline text-link'>{docLink.label}</a>
          </Link>
        )
      }
      sidebarSections={[
        {
          ...
          children: (
            <Select
              ...
              onChange={(value) => router.push(`/applications/${value}`)}
          ...
          items: [
            {
              ...
              icon: 'home',
              href: {
                pathname: '/applications/[applicationId]/information',
                query: {
            ...
            },
            {
              ...
              icon: 'key',
              href: {
                pathname: '/applications/[applicationId]/oauth2',
                query: {
                  applicationId: currentApplicationId,
                },
              },
            ...
            },
            {
              ...
              icon: 'more-info',
              href: {
                pathname: '/applications/[applicationId]/rich-presence',
                query: {
                  applicationId: currentApplicationId,
                },
              },
            ...
            // TODO: Hide Embedded Application behind the "EMBEDDED" flag on applications, probably through a predicate on the sidebar item?
            {
              ...
              icon: 'gamepad',
              href: {
                pathname: '/applications/[applicationId]/embedded',
                query: {
                  applicationId: currentApplicationId,
                },
              },
