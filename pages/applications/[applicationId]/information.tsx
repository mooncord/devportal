					...
					<div className="flex flex-wrap gap-12 flex-auto max-w-[450px]">
						...
						<div className="max-w-[270px]">
							<p className="mb-2 text-sm cursor-default text-header-secondary">
								We recommend an image of at least 512x512 for
			...
			<section>
				<div className="flex">
					...
					<input
						...
						onChange={event =>
							setInteractionsViaHTTP(event.target.checked)
						}
						className="ml-8"
						type="checkbox"
					/>
...
ApplicationInformation.getLayout = (page, router) => (
	<ApplicationLayout
		...
		docLink={{
			label: "By creating an API application, you agree to the Discord API Terms of Service",
			href: "/docs/legal",
		}}
	>
		{page}
